...
def generate_500_edge_cases() -> list[dict[str, Any]]:
    ...
    lg_templates = [
        ...
        ("Nnyinza ntya okuwakanya omusolo gwa URA gwe ssikkiriziganya nagwo?", "Disputes", ["ura", "misolo", "obutakkaanya"], ["tewali kuwakanya"]),
        ...
        ("Bizinensi entono ezitasobola kukuuma bitabo zisasula zitya presumptive tax?", "Presumptive", ["presumptive", "bukadde 10"], ["balirizi ba bitabo"]),
