...
def generate_100_faqs() -> list[FAQItem]:
    ...
    lg_templates = [
        ...
        ("Bwe mba sikwatagana na kubalirira kw'omusolo, nnina ennaku mmeka okwekubira ebyondo?", ["45"], "Objections"),
    ...
    sw_templates = [
        ...
        ("Nina siku ngapi za kuwasilisha pingamizi dhidi ya tathmini ya kodi ya URA?", ["45"], "Objections"),
