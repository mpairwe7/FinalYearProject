...
*Auto-generated by `ml.scripts.data_aug.pipeline.run_pipeline` — do not edit by hand.*
...
python -c "from ml.scripts.data_aug.pipeline import run_pipeline, PipelineConfig; run_pipeline(PipelineConfig(...))"
```
