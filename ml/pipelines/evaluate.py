...
def main():
    ...
    from ml.pipelines.train import load_qa_data, create_embeddings, load_config
    ...
    _, X_test, _, y_test = train_test_split(
        ...
        stratify=y, random_state=config['data']['random_seed']
    )
    ...
    metrics_export['confusion_matrix_shape'] = [len(metrics['confusion_matrix']), len(metrics['confusion_matrix'][0])]
