...
_HARDSHIP_RE = re.compile(
    ...
    r"|(?:i am|i'm|we are|my (?:child|son|daughter|wife|husband|mother|father|parent|family))\s+(?:very\s+)?(?:sick|ill|in hospital)"
    r"|(?:my|our)\s+(?:mother|father|wife|husband|child|son|daughter|parent)\s+(?:died|passed away)"
