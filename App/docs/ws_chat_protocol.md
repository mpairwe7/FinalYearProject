...
`escalated`} and deterministic procedural replies (curated TIN-registration
/ return-filing answers), which carry their real faithfulness score — 1.0
for curated templates — instead of an LLM-stream estimate.
