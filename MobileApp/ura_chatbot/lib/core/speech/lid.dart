...
class TrigramLid implements LanguageIdentifier {
  ...
  static const _lugandaTrigrams = <String>{
    'nna', 'nku', 'mbi', 'oku', 'aba', 'emu', 'omu', 'eki',
    'nsi', 'enn', 'aab', 'baa', 'gwa', 'kus', 'nge', 'ebi',
    'ssa', 'dde', 'gge', 'lwa', 'mwe', 'nny', 'waa', 'yaa',
    'bwe', 'ggi', 'kub', 'kwe', 'eri', 'ali', 'ani', 'awo',
  };

  /// Common English trigrams.
  static const _englishTrigrams = <String>{
    'the', 'and', 'ing', 'tha', 'hat', 'ent',
    'ion', 'ter', 'was', 'you', 'ith', 'ver', 'all', 'wit',
    'thi', 'his', 'fro', 'not', 'are', 'but', 'had', 'her',
    'wha', 'one', 'our', 'out', 'hav', 'bee', 'oul', 'ple',
  };

  /// Common Swahili trigrams (distinct from Luganda).
  static const _swahiliTrigrams = <String>{
    'ana', 'kwa', 'ndi', 'ina', 'wak', 'ame', 'ali', 'mba',
    'cha', 'shi', 'hak', 'nay', 'kat', 'ata', 'mtu', 'moj',
    'yen', 'wam', 'zan', 'nch', 'ung', 'end', 'umb', 'amb',
    'aka', 'ish', 'wan', 'kup', 'uli', 'fan', 'hij', 'sem',
  };

  /// Common Runyankole trigrams (Western Uganda Bantu).
  static const _runyankole = <String>{
    'oku', 'mun', 'eky', 'aba', 'nka', 'obu', 'rik', 'eki',
    'ira', 'tur', 'imu', 'mwe', 'aha', 'ntu', 'omu', 'eby',
    'kur', 'eit', 'ebi', 'gye', 'ngi', 'kye', 'ire', 'ban',
    'rwa', 'ore', 'ari', 'iza', 'iga', 'shy', 'muh', 'nyi',
  };

  /// Common Acholi trigrams (Nilotic, Northern Uganda).
  static const _acholiTrigrams = <String>{
    'gin', 'tic', 'nek', 'tye', 'aye', 'lok', 'bot',
    'pir', 'nge', 'kit', 'ber', 'wek', 'can', 'kwo',
    'olo', 'iyo', 'ami', 'ppe', 'dye', 'ngo', 'nye', 'yee',
    'aci', 'wil', 'oyo', 'eno', 'kom', 'cwi', 'tam', 'tur',
  };
  ...
  LidResult identify(String text) {
    ...
    if (best.value > 0.03 && second.value > 0.03 &&
